...
OUTPUT_FILE = Path("cold_stats_significance.txt")
...
def main() -> None:
    ...
    results_lines.append("Signifikanzanalyse Cold-Starts (Welch t-Test)")
    results_lines.append("Vergleich: mit OTel vs. ohne OTel")
    results_lines.append("")
    results_lines.append(f"Gefundene *-cold.csv Dateien: {len(all_cold_files)}")
