...
OUTPUT_FILE = Path("cold_bootstrap_comparisons.txt")
...
def main() -> None:
    ...
    results_lines = []
    results_lines.append("Bootstrap-Vergleich der relativen Overheads (Kaltstarts)")
    results_lines.append("Vergleich: Overhead in Sprache A > Overhead in Sprache B?")
    results_lines.append(f"Bootstrap-Wiederholungen pro Test: 100.000")
    ...
    for metric_key in metric_keys:
        ...
        overhead_data = {}  # key: (language, benchmark) -> array of overheads
